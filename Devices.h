...
extern  int  sys_disk_read(int unit, int track, int first, int sectors, void* buffer);
extern  int  sys_disk_write(int unit, int track, int first, int sectors, void* buffer);
extern  int  sys_disk_info(int unit, int *platters, int* sectors, int* tracks, int* disk);
